...
This project was developed with the assistance of an AI coding tool (ChatGPT). The AI tool was used as a development aid for architectural brainstorming, debugging assistance, and drafting boilerplate code and documentation. <br>
